...
inline void Test2() {
    ...
    // Вставка элементов
    {
        ...
        auto old_it = v.begin() + 2;
        assert(*old_it == 3);
        auto new_it = v.Insert(v.begin() + 2, 42);
        assert((v == SimpleVector<int>{1, 2, 42, 3, 4}));
        assert(*new_it == 42);
    }
    {
        SimpleVector<int> v{1, 2, 3, 4};
        auto new_it = v.Insert(v.begin() + 3, 42);
        assert((v == SimpleVector<int>{1, 2, 3, 42,4}));
        assert(*new_it == 42);
    }
    ...
    }
    {
        ...
        assert((v == SimpleVector<int>{1, 42, 2, 3, 4}));
    }
    ...
    // Удаление элементов c size < capacity
    {
        SimpleVector<int> v{1, 2, 3, 4};
        v.Erase(v.cbegin() + 2);
        assert((v == SimpleVector<int>{1, 2, 4}));
        v.Insert(v.begin() + 1, 42);
        assert((v == SimpleVector<int>{1, 42, 2, 4}));
    }
    // Удаление элементов c size < capacity
    {
        SimpleVector<int> v{1, 2, 3, 4};
        ...
        v.Insert(v.end(), 42);
        assert((v == SimpleVector<int>{1, 2, 3, 42}));
    }
    ...
    {
        SimpleVector a{1,2,3,4,5};
        a.Erase(a.begin() + 2);
        assert((a == SimpleVector<int>{1, 2, 4, 5}));
    }
